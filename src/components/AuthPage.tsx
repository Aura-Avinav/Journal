                    ...
                    {isSent ? (
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 bg-white text-black font-bold rounded-xl hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all flex items-center justify-center gap-3"
                            >
